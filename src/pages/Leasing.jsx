...
// import EmployeesLeasingImage1 from "../assets/leasing1.png"; // Replace with actual paths
// import EmployersLeasingImage2 from "../assets/leasing2.png"; // Replace with actual paths
...
//           <img
//             src={EmployeesLeasingImage1} // Use imported image
...
//         <div className="relative flex-1 bg-gray-200 rounded-lg overflow-hidden shadow-lg group">
//           <img
//             src={EmployersLeasingImage2} // Use imported image
...
import React from "react";
import EmployeesLeasingImage1 from "../assets/leasing1.png"; // your actual path
import EmployersLeasingImage2 from "../assets/leasing2.png"; // your actual path

const LeasingSection = () => {
  return (
    <section
      id="Leasing"
      className="w-full bg-[#f9f5ef] px-10 py-20 flex flex-col lg:flex-row items-center justify-between gap-10"
    >
      {/* Left: Text Content */}
      <div className="flex flex-col gap-6 max-w-xl text-left">
        <p className="text-lg font-medium text-gray-700 mb-2">LEASING</p>
        <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-8">
          Affordable monthly plans with maximum flexibility.
        </h1>
        <p className="text-lg text-gray-700 mt-2">An option for every rider</p>
      </div>
